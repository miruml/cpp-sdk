...
std::string InvalidContentTypeError::format_message(
  ...
  return "Request '" + miru::http::details::to_string(details) + "' returned content type '" +
...
std::string ConnectionError::format_message(
  ...
  return "Request '" + miru::http::details::to_string(details) +
...
std::string RequestFailedError::format_message(
  ...
  return "Request '" + miru::http::details::to_string(details) + "' returned status '" +
...
std::string RequestTimeoutError::format_message(
  ...
  return "Request '" + miru::http::details::to_string(details) +
         "' timed out: " + error_message + miru::errors::details::format_source_location(trace);
}
