...
class ResolveError : public std::runtime_error {
 public:
  ResolveError(
    ...
    : std::runtime_error(format_message(error_message, context, trace)) {}
...
#define THROW_RESOLVE_ERROR(error_message, context) \
  throw miru::http::errors::ResolveError(error_message, context, ERROR_TRACE)
...
#define THROW_CONNECTION_ERROR(error_message, context) \
  throw miru::http::errors::ConnectionError(error_message, context, ERROR_TRACE)
...
#define THROW_WRITE_ERROR(error_message, context) \
  throw miru::http::errors::WriteError(error_message, context, ERROR_TRACE)
...
#define THROW_READ_ERROR(error_message, context) \
  throw miru::http::errors::ReadError(error_message, context, ERROR_TRACE)
...
#define THROW_SHUTDOWN_ERROR(error_message, context) \
  throw miru::http::errors::ShutdownError(error_message, context, ERROR_TRACE)
