...
bool Error::validate(std::stringstream& msg) const { return validate(msg, ""); }
...
bool Error::operator==(const Error& other) const {
  return
    ...
    code == other.code && params == other.params && message == other.message &&
    debug_message == other.debug_message;
}
