...
int main() {
    ...
    bool success = ros2_config_instance.get_parameter(
        param_name,
        result
    );
    if (success) {
    ...
    success = ros2_config_instance.get_parameter(
        param_name,
        result_value
    );
    if (success) {
    ...
    result_value = ros2_config_instance.get_parameter_or(
        param_name,
        default_value
    );
    ...
    default_value = 46;
    success = ros2_config_instance.get_parameter_or(
        param_name,
        result_value,
        default_value
    );
