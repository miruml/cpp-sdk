...
INSTANTIATE_TEST_SUITE_P(
    Path, Paths,
    testing::Values(
        PathTestCase{"test/file_test/test.txt",
        ...
        PathTestCase{"ske/de/pop/pop/pop.txt",
...
INSTANTIATE_TEST_SUITE_P(
    Path, AbsPaths,
    testing::Values(
        AbsPathTestCase{"already absolute path",
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        // files
        NameTestCase{"json file", std::filesystem::path("arglebargle.json"),
                     std::filesystem::path("arglebargle.json")},
        NameTestCase{"text file",
                     std::filesystem::path("ske") / "de" / "pop" / "pop" / "pop.txt",
                     std::filesystem::path("pop.txt")},
        // dirs
        NameTestCase{"test directory",
