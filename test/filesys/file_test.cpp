...
INSTANTIATE_TEST_SUITE_P(File, FileTypeStringConversion,
    testing::Values(
...
INSTANTIATE_TEST_SUITE_P(File, Extensions,
    testing::Values(
        ExtensionTestCase{
            "txt file",
...
INSTANTIATE_TEST_SUITE_P(File, FileTypes,
    testing::Values(
        FileTypeTestCase{
            "json file",
            std::filesystem::path("arglebargle.json"),
...
TEST_P(AssertExistsTest, AssertExists) {
    ...
    switch (test_case.expected_exception) {
        ...
        case FileExceptionType::NotAFile:
            ...
            break;
        default:
            FAIL() << "Unexpected exception type: " << static_cast<int>(test_case.expected_exception);
    }
}
...
INSTANTIATE_TEST_SUITE_P(File, AssertExistsTest,
    testing::Values(
        // file exists
...
protected:
    ...
    miru::filesys::File invalid_file_type = miru::test_utils::filesys_testdata_dir().file("text.txt");
    miru::filesys::File invalid_json_file = miru::test_utils::filesys_testdata_dir().file("invalid.json");
...
protected:
    ...
    miru::filesys::File invalid_file_type = miru::test_utils::filesys_testdata_dir().file("text.txt");
    miru::filesys::File invalid_yaml_file = miru::test_utils::filesys_testdata_dir().file("invalid.yaml");
    miru::filesys::File json_file = miru::test_utils::filesys_testdata_dir().file("valid.json");
    miru::filesys::File yaml_file = miru::test_utils::filesys_testdata_dir().file("valid.yaml");
    miru::filesys::File yml_file = miru::test_utils::filesys_testdata_dir().file("valid.yml");
};
