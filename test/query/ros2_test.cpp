...
TEST(ROS2HasParamTests, Exists) {
  ...
  EXPECT_EQ(ROS2NodeI.has_parameter("exists"), true);
}

TEST(ROS2HasParamTests, DoesntExist) {
  miru::params::Parameter parameter;
  miru::query::ROS2NodeI ROS2NodeI(parameter);
  EXPECT_EQ(ROS2NodeI.has_parameter("doesnt_exist"), false);
}
...
TEST(ROS2GetParamTests, Exists) {
  miru::params::Parameter parameter("exists", 42.3);
  miru::query::ROS2NodeI ROS2NodeI(parameter);
  EXPECT_EQ(ROS2NodeI.get_parameter("exists").as<double>(), 42.3);
}
...
TEST(ROS2GetParamWithDefaultParameterTests, Exists) {
  ...
  EXPECT_EQ(ROS2NodeI.get_parameter("exists", default_parameter), true);
...
TEST(ROS2GetParamWithDefaultParameterTests, DoesntExist) {
  ...
  EXPECT_EQ(ROS2NodeI.get_parameter("doesnt_exist", default_parameter), false);
...
TEST(ROS2GetParamWithDefaultValueTests, Exists) {
  ...
  EXPECT_EQ(ROS2NodeI.get_parameter("exists", default_value), true);
...
TEST(ROS2GetParamWithDefaultValueTests, InvalidType) {
  ...
  EXPECT_THROW(
    ROS2NodeI.get_parameter("exists", default_value),
...
TEST(ROS2GetParamWithDefaultValueTests, DoesntExist) {
  ...
  EXPECT_EQ(ROS2NodeI.get_parameter("doesnt_exist", default_value), false);
...
TEST(ROS2TryGetParamTests, Exists) {
  ...
  EXPECT_EQ(ROS2NodeI.get_parameter_or("exists", default_value), 42.3);
}
...
TEST(ROS2TryGetParamTests, InvalidType) {
  ...
  EXPECT_THROW(
    ROS2NodeI.get_parameter_or("exists", default_value),
    miru::params::details::InvalidParameterTypeError
  );
}
...
TEST(ROS2TryGetParamTests, DoesntExist) {
  ...
  EXPECT_EQ(ROS2NodeI.get_parameter_or("doesnt_exist", default_value), 100.0);
}
...
TEST(ROS2TryGetParamWithDefaultValueTests, Exists) {
  ...
  EXPECT_EQ(ROS2NodeI.get_parameter_or("exists", result_value, default_value), true);
...
TEST(ROS2TryGetParamWithDefaultValueTests, InvalidType) {
  ...
  EXPECT_THROW(
    ROS2NodeI.get_parameter_or("exists", result_value, default_value),
    miru::params::details::InvalidParameterTypeError
  );
}
...
TEST(ROS2GetParamsTests, Simple) {
  ...
  auto params = ROS2NodeI.get_parameters({"root"});
...
TEST(ROS2GetParamsTests, DoesntExist) {
  ...
  miru::query::ROS2NodeI ROS2NodeI(parameter);
  EXPECT_THROW(
    ROS2NodeI.get_parameters({"root", "doesnt_exist"}),
    miru::query::details::ParameterNotFoundError
  );
}
