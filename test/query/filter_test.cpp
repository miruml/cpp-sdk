...
TEST_F(SearchParamFiltersMatchingTest, MatchesComplex1) {
  ...
  // matches
  EXPECT_TRUE(filters.matches(miru::params::Parameter("prefix.test")));
  EXPECT_TRUE(filters.matches(miru::params::Parameter("prefix.test2")));

  // doesn't match
  EXPECT_FALSE(filters.matches(miru::params::Parameter("prefix.test.hello")));
  miru::params::Parameter map = miru::params::Parameter(
    "prefix.test",
    miru::params::Map(
...
TEST_F(SearchParamFiltersMatchingTest, MatchesComplex2) {
  ...
  EXPECT_TRUE(filters.matches(miru::params::Parameter("prefix.test")));
  EXPECT_TRUE(filters.matches(miru::params::Parameter("prefix.test2")));
  EXPECT_TRUE(filters.matches(miru::params::Parameter("prefix.test.hello")));
