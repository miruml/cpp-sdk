...
TEST_F(MapArrayConstructor, duplicate_field_names) {
  ...
  miru::params::Parameter param2(
      "0", miru::params::Map({miru::params::Parameter("0/string3", "value3"),
...
TEST_F(MapArrayConstructor, mismatching_parent_names) {
  ...
  miru::params::Parameter param2(
      "parent2/0",
      miru::params::Map({miru::params::Parameter("parent2/0/string3", "value3"),
...
TEST_F(MapArrayConstructor, invalid_array_indices) {
  ...
  miru::params::Parameter param2(
      "parent/2",
      miru::params::Map({miru::params::Parameter("parent/2/string3", "value3"),
