...
TEST_F(MapAccessor, nested_field) {
    miru::params::Parameter param1("deeply/nested/field1", miru::params::Scalar("value1"));
    miru::params::Parameter param2("deeply/nested/field2", miru::params::Scalar("value2"));
    miru::params::Map map({param1, param2});
    EXPECT_EQ(map["field1"].as_string(), "value1");
    EXPECT_EQ(map["field2"].as_string(), "value2");
}
...
TEST_F(MapAccessor, many_fields) {
    ...
    miru::params::Map map({param1, param2, param3, param4, param5, param6, param7, param8, param9, param10});
    EXPECT_EQ(map["field1"].as_string(), "value1");
    EXPECT_EQ(map["field2"].as_string(), "value2");
...
TEST_F(MapArrayConstructor, duplicate_field_names) {
    ...
    miru::params::Parameter param1("0", miru::params::Map({
        miru::params::Parameter("0/scalar1", miru::params::Scalar("value1")),
        miru::params::Parameter("0/int", 2)
    }));
    miru::params::Parameter param2("0", miru::params::Map({
...
TEST_F(MapArrayConstructor, mismatching_parent_names) {
    ...
    miru::params::Parameter param1("parent1/0", miru::params::Map({
        miru::params::Parameter("parent1/0/scalar1", miru::params::Scalar("value1")),
        miru::params::Parameter("parent1/0/int", 2)
    }));
    miru::params::Parameter param2("parent2/0", miru::params::Map({
        miru::params::Parameter("parent2/0/string3", "value3"),
        miru::params::Parameter("parent2/0/float4", 4.0)
    }));
    EXPECT_THROW(
        miru::params::MapArray(std::vector<miru::params::Parameter>({param1, param2})),
        miru::params::MismatchingParentNames
...
TEST_F(MapArrayConstructor, invalid_array_indices) {
    ...
    miru::params::Parameter param1("parent/0", miru::params::Map({
        miru::params::Parameter("parent/0/scalar1", miru::params::Scalar("value1")),
        miru::params::Parameter("parent/0/int", 2)
    }));
    miru::params::Parameter param2("parent/2", miru::params::Map({
...
TEST_F(MapArrayConstructor, success) {
    ...
    miru::params::Parameter param2("parent/1", miru::params::Map({
...
TEST_F(NestedArrayConstructor, duplicate_field_names) {
