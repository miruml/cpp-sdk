...
TEST_F(ParseJsonNode, DoesntExist) {
  ...
  auto param = miru::params::details::parse_json_node("doesnt_exist", doesnt_exist_json);
...
TEST_F(ParseJsonNode, ValidBool) {
  ...
  auto param = miru::params::details::parse_json_node("test", bool_json);
...
TEST_F(ParseJsonNode, ValidInt) {
  ...
  auto param = miru::params::details::parse_json_node("test", int_json);
...
TEST_F(ParseJsonNode, ValidDouble) {
  ...
  auto param = miru::params::details::parse_json_node("test", double_json);
...
TEST_F(ParseJsonNode, ValidString) {
  ...
  auto param = miru::params::details::parse_json_node("test", string_json);
...
TEST_F(ParseJsonNode, ValidBoolArray) {
  ...
  auto param = miru::params::details::parse_json_node("test", bool_array_json);
...
TEST_F(ParseJsonNode, ValidIntArray) {
  ...
  auto param = miru::params::details::parse_json_node("test", int_array_json);
...
TEST_F(ParseJsonNode, ValidDoubleArray) {
  ...
  auto param = miru::params::details::parse_json_node("test", double_array_json);
...
TEST_F(ParseJsonNode, ValidStringArray) {
  ...
  auto param = miru::params::details::parse_json_node("test", string_array_json);
...
TEST_F(ParseJsonNode, ValidNull) {
  ...
  auto param = miru::params::details::parse_json_node("test", null_json);
...
TEST_F(ParseJsonNode, ValidNestedArray) {
  ...
  auto param = miru::params::details::parse_json_node("config-slug", nested_array_json);
...
TEST_F(ParseJsonNode, ValidDeepNestedArray) {
  ...
  auto param = miru::params::details::parse_json_node("config-slug", deep_nested_array_json);
...
TEST_F(ParseJsonNode, ValidMap) {
  nlohmann::json json = json_file.read_json();
  auto param = miru::params::details::parse_json_node("test", json);
...
TEST_F(ParseJsonNode, ValidMapArray) {
  ...
  auto param = miru::params::details::parse_json_node("config-slug", map_array_json);
...
TEST_F(ParseYamlNode, DoesntExist) {
  ...
  EXPECT_THROW(
    miru::params::details::parse_yaml_node("doesnt_exist", doesnt_exist_yaml),
    std::runtime_error
  );
}
...
TEST_F(ParseYamlNode, ValidBool) {
  ...
  auto param = miru::params::details::parse_yaml_node("test", bool_yaml);
...
TEST_F(ParseYamlNode, ValidInt) {
  ...
  auto param = miru::params::details::parse_yaml_node("test", int_yaml);
...
TEST_F(ParseYamlNode, ValidDouble) {
  ...
  auto param = miru::params::details::parse_yaml_node("test", double_yaml);
...
TEST_F(ParseYamlNode, ValidString) {
  ...
  auto param = miru::params::details::parse_yaml_node("test", string_yaml);
...
TEST_F(ParseYamlNode, ValidBoolArray) {
  ...
  auto param = miru::params::details::parse_yaml_node("test", bool_array_yaml);
...
TEST_F(ParseYamlNode, ValidIntArray) {
  ...
  auto param = miru::params::details::parse_yaml_node("test", int_array_yaml);
...
TEST_F(ParseYamlNode, ValidDoubleArray) {
  ...
  auto param = miru::params::details::parse_yaml_node("test", double_array_yaml);
...
TEST_F(ParseYamlNode, ValidStringArray) {
  ...
  auto param = miru::params::details::parse_yaml_node("test", string_array_yaml);
...
TEST_F(ParseYamlNode, ValidNull) {
  ...
  auto param = miru::params::details::parse_yaml_node("test", null_yaml);
...
TEST_F(ParseYamlNode, ValidNestedArray) {
  ...
  auto param = miru::params::details::parse_yaml_node("config-slug", nested_array_yaml);
  ...
  EXPECT_EQ(
    ...
    miru::params::NestedArray(
      {miru::params::Parameter(
       ...
       miru::params::Parameter(
         "config-slug.2", std::vector<Scalar>({Scalar("7"), Scalar("8"), Scalar("9")})
       )}
    )
  );
}
...
TEST_F(ParseYamlNode, ValidDeepNestedArray) {
  ...
  auto param = miru::params::details::parse_yaml_node("config-slug", deep_nested_array_yaml);
...
TEST_F(ParseYamlNode, ValidMap) {
  YAML::Node yaml = yaml_file.read_yaml();
  auto param = miru::params::details::parse_yaml_node("test", yaml);
  EXPECT_EQ(param.get_type(), miru::params::ParameterType::PARAMETER_MAP);
  // all of these individual values are tested above so we'll just let this rest
}
...
TEST_F(ParseYamlNode, ValidMapArray) {
  ...
  auto param = miru::params::details::parse_yaml_node("config-slug", map_array_yaml);
