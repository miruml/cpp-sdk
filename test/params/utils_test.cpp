...
TEST_F(ParamUtils, string_variant) {
  miru::params::Parameter string_param = miru::params::Parameter("string_param", "test");
...
TEST_F(ParamUtils, int_array_variant) {
  ...
  EXPECT_TRUE(int_array_param.get_type() == miru::params::ParameterType::PARAMETER_INTEGER_ARRAY);
...
TEST_F(ParamUtils, double_array_variant) {
  ...
  EXPECT_TRUE(double_array_param.get_type() == miru::params::ParameterType::PARAMETER_DOUBLE_ARRAY);
...
TEST_F(ParamUtils, string_array_variant) {
  miru::params::Parameter string_array_param =
      miru::params::Parameter("string_array_param", std::vector<std::string>{"test1", "test2", "test3"});
  EXPECT_TRUE(string_array_param.get_type() == miru::params::ParameterType::PARAMETER_STRING_ARRAY);
...
TEST_F(ParamUtils, scalar_variant) {
  miru::params::Parameter scalar_param = miru::params::Parameter("scalar_param", miru::params::Scalar("test"));
...
TEST_F(ParamUtils, scalar_array_variant) {
  miru::params::Parameter scalar_array_param = miru::params::Parameter("scalar_array_param", std::vector<miru::params::Scalar>{
      miru::params::Scalar("true"), miru::params::Scalar("false"),
      miru::params::Scalar("true")});
  EXPECT_TRUE(scalar_array_param.get_type() == miru::params::ParameterType::PARAMETER_SCALAR_ARRAY);
