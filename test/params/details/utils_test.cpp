...
TEST_F(ParamUtils, not_set_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(not_set));
  EXPECT_FALSE(miru::params::details::has_children(not_set));
  EXPECT_TRUE(miru::params::details::get_children_view(not_set).empty());
}
...
TEST_F(ParamUtils, bool_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(bool_param));
  EXPECT_FALSE(miru::params::details::has_children(bool_param));
  EXPECT_TRUE(miru::params::details::get_children_view(bool_param).empty());
}
...
TEST_F(ParamUtils, int_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(int_param));
  EXPECT_FALSE(miru::params::details::has_children(int_param));
  EXPECT_TRUE(miru::params::details::get_children_view(int_param).empty());
}
...
TEST_F(ParamUtils, double_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(double_param));
  EXPECT_FALSE(miru::params::details::has_children(double_param));
  EXPECT_TRUE(miru::params::details::get_children_view(double_param).empty());
}
...
TEST_F(ParamUtils, string_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(string_param));
  EXPECT_FALSE(miru::params::details::has_children(string_param));
  EXPECT_TRUE(miru::params::details::get_children_view(string_param).empty());
}
...
TEST_F(ParamUtils, bool_array_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(bool_array_param));

  EXPECT_FALSE(miru::params::details::has_children(bool_array_param));
  EXPECT_TRUE(miru::params::details::get_children_view(bool_array_param).empty());
}
...
TEST_F(ParamUtils, int_array_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(int_array_param));
  EXPECT_FALSE(miru::params::details::has_children(int_array_param));
  EXPECT_TRUE(miru::params::details::get_children_view(int_array_param).empty());
}
...
TEST_F(ParamUtils, double_array_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(double_array_param));
  EXPECT_FALSE(miru::params::details::has_children(double_array_param));
  EXPECT_TRUE(miru::params::details::get_children_view(double_array_param).empty());
}
...
TEST_F(ParamUtils, string_array_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(string_array_param));
  EXPECT_FALSE(miru::params::details::has_children(string_array_param));
  EXPECT_TRUE(miru::params::details::get_children_view(string_array_param).empty());
}
...
TEST_F(ParamUtils, null_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(null_param));
  EXPECT_FALSE(miru::params::details::has_children(null_param));
  EXPECT_TRUE(miru::params::details::get_children_view(null_param).empty());
}
...
TEST_F(ParamUtils, scalar_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(scalar_param));
  EXPECT_FALSE(miru::params::details::has_children(scalar_param));
  EXPECT_TRUE(miru::params::details::get_children_view(scalar_param).empty());
}
...
TEST_F(ParamUtils, scalar_array_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(scalar_array_param));
  EXPECT_FALSE(miru::params::details::has_children(scalar_array_param));
  EXPECT_TRUE(miru::params::details::get_children_view(scalar_array_param).empty());
}
...
TEST_F(ParamUtils, nested_array_variant) {
  ...
  EXPECT_TRUE(miru::params::details::is_leaf(nested_array_param));
  EXPECT_TRUE(miru::params::details::has_children(nested_array_param));
  int i = 0;
  for (const auto& child : miru::params::details::get_children_view(nested_array_param)) {
    if (i == 0) {
      EXPECT_EQ(child.get_name(), "nested_array.0");
    } else if (i == 1) {
      EXPECT_EQ(child.get_name(), "nested_array.1");
    }
    EXPECT_TRUE(miru::params::details::is_leaf(child));
    EXPECT_FALSE(miru::params::details::has_children(child));
    EXPECT_TRUE(miru::params::details::get_children_view(child).empty());
    i++;
  }
  EXPECT_EQ(i, 2);
}
...
TEST_F(ParamUtils, map_variant) {
  ...
  EXPECT_FALSE(miru::params::details::is_leaf(map_param));
  EXPECT_TRUE(miru::params::details::has_children(map_param));
  int i = 0;
  for (const auto& child : miru::params::details::get_children_view(map_param)) {
    if (i == 0) {
...
TEST_F(ParamUtils, map_array_variant) {
  ...
  EXPECT_FALSE(miru::params::details::is_leaf(map_array));
  EXPECT_TRUE(miru::params::details::has_children(map_array));
  int i = 0;
  for (const auto& child : miru::params::details::get_children_view(map_array)) {
    if (i == 0) {
      EXPECT_EQ(child.get_name(), "maps.0");
    } else if (i == 1) {
      EXPECT_EQ(child.get_name(), "maps.1");
    }
    EXPECT_FALSE(miru::params::details::is_leaf(child));
    EXPECT_TRUE(miru::params::details::has_children(child));
    EXPECT_FALSE(miru::params::details::get_children_view(child).empty());
    i++;
  }
  EXPECT_EQ(i, 2);
}
