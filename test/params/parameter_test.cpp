...
TEST_F(ParameterConstructors, trailing_delimiter_in_constructor) {
  ...
  miru::params::Parameter param1_constructor2 = miru::params::Parameter(
    "test.", value
  );
  miru::params::Parameter param1_constructor3 = miru::params::Parameter(
    "test.", 2
  );
  ...
  miru::params::Parameter param2_constructor2 = miru::params::Parameter(
    "l1.l2.", value
  );
  miru::params::Parameter param2_constructor3 = miru::params::Parameter(
    "l1.l2.", 2
  );
  ...
  miru::params::Parameter param3_constructor2 = miru::params::Parameter(
    "l1.l2.l3.", value
  );
  miru::params::Parameter param3_constructor3 = miru::params::Parameter(
    "l1.l2.l3.", 2
  );
  ...
  miru::params::Parameter param4_constructor2 = miru::params::Parameter(
    "l1.l2.l3...", value
  );
  miru::params::Parameter param4_constructor3 = miru::params::Parameter(
    "l1.l2.l3...", 2
  );
...
TEST_F(ParameterConstructors, not_set_variant) {
  ...
  // get type
  EXPECT_EQ(not_set_variant1.get_type(),
...
TEST_F(ParameterConstructors, bool_array_variant) {
  ...
  // get type
  EXPECT_EQ(bool_array_variant1.get_type(),
...
TEST_F(ParameterConstructors, int_array_variant) {
  ...
  // get type
  EXPECT_EQ(int_array_variant1.get_type(),
...
TEST_F(ParameterConstructors, double_array_variant) {
  ...
  // get type
  EXPECT_EQ(double_array_variant1.get_type(),
...
TEST_F(ParameterConstructors, string_array_variant) {
  ...
  // get type
  EXPECT_EQ(string_array_variant1.get_type(),
  ...
  // value to string
  EXPECT_EQ(string_array_variant1.value_to_string(),
            "[\"test1\", \"test2\", \"test3\"]");
...
TEST_F(ParameterConstructors, scalar_array_variant) {
  ...
  miru::params::Parameter scalar_array_variant2 = miru::params::Parameter(
      "scalar_array_param",
      std::vector<miru::params::Scalar>{miru::params::Scalar("true"),
  ...
  // get type
  EXPECT_EQ(scalar_array_variant1.get_type(),
...
TEST_F(ParameterConstructors, nested_array_variant) {
  ...
  // get type
  EXPECT_EQ(nested_array_variant1.get_type(),
      ...
      miru::params::MapArray{std::vector<miru::params::Parameter>{
          miru::params::Parameter(
              ...
              miru::params::Map{std::vector<miru::params::Parameter>{
                  miru::params::Parameter("nested_array.0.0.scalar1",
                                          miru::params::Scalar("test1")),
                  miru::params::Parameter("nested_array.0.0.scalar2",
                                          miru::params::Scalar("test2"))}}),
          miru::params::Parameter(
              "nested_array.0.1",
              miru::params::Map{std::vector<miru::params::Parameter>{
                  miru::params::Parameter("nested_array.0.1.scalar1",
                                          miru::params::Scalar("test3")),
                  miru::params::Parameter("nested_array.0.1.scalar2",
  ...
  miru::params::ParameterValue map_array_item2 = miru::params::ParameterValue(
      miru::params::MapArray{std::vector<miru::params::Parameter>{
          miru::params::Parameter(
              "nested_array.1.0",
              miru::params::Map{std::vector<miru::params::Parameter>{
                  miru::params::Parameter("nested_array.1.0.scalar1",
                                          miru::params::Scalar("test5")),
                  miru::params::Parameter("nested_array.1.0.scalar2",
                                          miru::params::Scalar("test6"))}}),
          miru::params::Parameter(
              "nested_array.1.1",
              miru::params::Map{std::vector<miru::params::Parameter>{
                  miru::params::Parameter("nested_array.1.1.scalar1",
                                          miru::params::Scalar("test7")),
                  miru::params::Parameter("nested_array.1.1.scalar2",
                                          miru::params::Scalar("test8"))}})}});
...
TEST_F(ParameterConstructors, nested_array_variant_parent_name_mismatch) {
  ...
  EXPECT_THROW(miru::params::Parameter(
                   "nested_array",
                   miru::params::NestedArray{std::vector<miru::params::Parameter>{
                       miru::params::Parameter("too/deep/nested_array.0",
...
TEST_F(ParameterConstructors, map_variant) {
  ...
  miru::params::Parameter diff_name = miru::params::Parameter(
      ...
      miru::params::Map{std::vector<miru::params::Parameter>{
          ...
          miru::params::Parameter("arglebargle.param2",
                                  miru::params::Scalar("test3"))}});
  ...
  // value to string
  EXPECT_EQ(map_variant1.value_to_string(),
            "{\n  \"param1\": \"test1\",\n  \"param2\": \"test2\"\n}");
...
TEST_F(ParameterConstructors, map_array_variant) {
  ...
  miru::params::Parameter diff_name = miru::params::Parameter(
      ...
      miru::params::MapArray{std::vector<miru::params::Parameter>{
          miru::params::Parameter(
              "arglebargle.0",
              miru::params::Map{std::vector<miru::params::Parameter>{
                  miru::params::Parameter("arglebargle.0.param1",
                                          miru::params::Scalar("test1")),
                  miru::params::Parameter("arglebargle.0.param2",
                                          miru::params::Scalar("test3"))}}),
          miru::params::Parameter(
              "arglebargle.1",
              miru::params::Map{std::vector<miru::params::Parameter>{
                  miru::params::Parameter("arglebargle.1.param1",
                                          miru::params::Scalar("test3")),
  ...
  // get type
  EXPECT_EQ(map_array_variant1.get_type(),
  ...
  // value to string
  EXPECT_EQ(map_array_variant1.value_to_string(),
            "[\n  {\n    \"param1\": \"test1\",\n    \"param2\": \"test2\"\n  },\n  "
            "{\n    \"param1\": \"test3\",\n    \"param2\": \"test4\"\n  }\n]");
...
TEST_F(ParameterConstructors, map_array_variant_parent_name_mismatch) {
      ...
      miru::params::Parameter(
          ...
          miru::params::MapArray{std::vector<miru::params::Parameter>{
              miru::params::Parameter(
                  "too.deep.map.0",
                  miru::params::Map{std::vector<miru::params::Parameter>{
                      miru::params::Parameter("too/deep/map.0.param1",
                                              miru::params::Scalar("test1")),
                      miru::params::Parameter("too/deep/map.0.param2",
                                              miru::params::Scalar("test3"))}}),
              miru::params::Parameter(
                  "too.deep.map.1",
                  miru::params::Map{std::vector<miru::params::Parameter>{
                      miru::params::Parameter("too.deep.map.1.param1",
                                              miru::params::Scalar("test3")),
  ...
  EXPECT_THROW(
      miru::params::Parameter(
          ...
          miru::params::MapArray{std::vector<miru::params::Parameter>{
              miru::params::Parameter(
                  "map.0", miru::params::Map{std::vector<miru::params::Parameter>{
                               miru::params::Parameter("map.0.param1",
                                                       miru::params::Scalar("test1")),
                               miru::params::Parameter(
                                   "map.0.param2", miru::params::Scalar("test3"))}}),
              miru::params::Parameter(
                  "too.deep.map.1",
                  miru::params::Map{std::vector<miru::params::Parameter>{
                      miru::params::Parameter("map.1.param1",
                                              miru::params::Scalar("test3")),
...
void test_conversion_type_exceptions(
  ...
  if (std::find(exclude.begin(), exclude.end(),
                miru::params::ParameterType::PARAMETER_BOOL) == exclude.end()) {
  ...
  // integer
  if (std::find(exclude.begin(), exclude.end(),
                miru::params::ParameterType::PARAMETER_INTEGER) == exclude.end()) {
    test_conversion_funcs_throw_type_exceptions(
        param,
        {
            [&]() { param.as_int(); },
  ...
  // double
  if (std::find(exclude.begin(), exclude.end(),
                miru::params::ParameterType::PARAMETER_DOUBLE) == exclude.end()) {
    test_conversion_funcs_throw_type_exceptions(
        param,
        {[&]() { param.as_double(); },
  ...
  // string
  if (std::find(exclude.begin(), exclude.end(),
                miru::params::ParameterType::PARAMETER_STRING) == exclude.end()) {
    test_conversion_funcs_throw_type_exceptions(
        param,
        {[&]() { param.as_string(); },
  ...
  // null
  if (std::find(exclude.begin(), exclude.end(),
                miru::params::ParameterType::PARAMETER_NULL) == exclude.end()) {
    test_conversion_funcs_throw_type_exceptions(
        param,
        {[&]() { param.as_null(); },
  ...
  // scalar
  if (std::find(exclude.begin(), exclude.end(),
                miru::params::ParameterType::PARAMETER_SCALAR) == exclude.end()) {
    test_conversion_funcs_throw_type_exceptions(
        param,
        {[&]() { param.as_scalar(); },
  ...
  // map
  if (std::find(exclude.begin(), exclude.end(),
                miru::params::ParameterType::PARAMETER_MAP) == exclude.end()) {
    test_conversion_funcs_throw_type_exceptions(
        param,
        {[&]() { param.as_map(); },
...
TEST_F(ParameterInvalidTypeConversions, scalar_array_integer_variant) {
  miru::params::Parameter scalar_array_variant = miru::params::Parameter(
      "scalar_array_param", std::vector<miru::params::Scalar>{
                                miru::params::Scalar("1"), miru::params::Scalar("2"),
...
TEST_F(ParameterInvalidTypeConversions, scalar_array_double_variant) {
  miru::params::Parameter scalar_array_variant = miru::params::Parameter(
      "scalar_array_param",
      std::vector<miru::params::Scalar>{miru::params::Scalar("1.1"),
...
TEST_F(ParameterInvalidTypeConversions, scalar_array_string_variant) {
  miru::params::Parameter scalar_array_variant = miru::params::Parameter(
      "scalar_array_param",
      std::vector<miru::params::Scalar>{miru::params::Scalar("test1"),
                                        miru::params::Scalar("test2"),
                                        miru::params::Scalar("test3")});
  std::vector<miru::params::ParameterType> exclude = {
      miru::params::ParameterType::PARAMETER_SCALAR_ARRAY,
...
TEST_F(ParameterValidTypeConversions, scalar_int_type_conversion_success) {
  ...
  EXPECT_EQ(int64.get_value<int64_t>(), int64_t(9223372036854775807));
  miru::params::Parameter int64_negative = miru::params::Parameter(
      "int_param", miru::params::Scalar("-9223372036854775807"));
  EXPECT_EQ(int64_negative.get_value<int64_t>(), int64_t(-9223372036854775807));
  ...
  std::function<std::vector<std::function<std::vector<bool>()>>(
      ...
      build_conversion_funcs = [](const miru::params::Parameter &param) {
        return std::vector<std::function<std::vector<bool>()>>{
            ...
            [&]() {
              return param
                  .get_value<miru::params::ParameterType::PARAMETER_BOOL_ARRAY>();
            },
...
TEST_F(ParameterValidTypeConversions, int_array_type_conversion_success) {
  std::function<std::vector<std::function<std::vector<int64_t>()>>(
    ...
    return std::vector<std::function<std::vector<int64_t>()>>{
        ...
        [&]() -> std::vector<int64_t> {
          return param
              .get_value<miru::params::ParameterType::PARAMETER_INTEGER_ARRAY>();
        },
        [&]() -> std::vector<int64_t> {
          return param.get_value<std::vector<int64_t>>();
        },
    };
  };
...
TEST_F(ParameterValidTypeConversions, scalar_int_array_type_conversion_success) {
  ...
  miru::params::Parameter int_array_variant = miru::params::Parameter(
      "int_array_param", std::vector<miru::params::Scalar>{miru::params::Scalar("1"),
  ...
  std::function<std::vector<std::function<std::vector<double>()>>(
      ...
      build_conversion_funcs = [](const miru::params::Parameter &param) {
        return std::vector<std::function<std::vector<double>()>>{
            ...
            [&]() {
              return param
                  .get_value<miru::params::ParameterType::PARAMETER_DOUBLE_ARRAY>();
            },
...
TEST_F(ParameterValidTypeConversions, scalar_double_array_type_conversion_success) {
  ...
  miru::params::Parameter double_array_variant = miru::params::Parameter(
      "double_array_param",
      std::vector<miru::params::Scalar>{miru::params::Scalar("1.0"),
  ...
  std::function<std::vector<std::function<std::vector<std::string>()>>(
      ...
      build_conversion_funcs = [](const miru::params::Parameter &param) {
        return std::vector<std::function<std::vector<std::string>()>>{
            ...
            [&]() {
              return param
                  .get_value<miru::params::ParameterType::PARAMETER_STRING_ARRAY>();
            },
