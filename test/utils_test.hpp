...
// ================================== INTEGERS ===================================== //
using IntVariants = std::variant<int8_t, int16_t, int32_t, int64_t, uint8_t, uint16_t,
                                 uint32_t, uint64_t>;
...
class IntegerCasting : public ::testing::Test {
 protected:
  ...
  std::vector<IntCastTestCase> all_test_cases() {
    std::vector<IntCastTestCase> all_test_cases = {};
    all_test_cases.insert(all_test_cases.end(), int8_test_cases.begin(),
                          int8_test_cases.end());
    all_test_cases.insert(all_test_cases.end(), int16_test_cases.begin(),
                          int16_test_cases.end());
    all_test_cases.insert(all_test_cases.end(), int32_test_cases.begin(),
                          int32_test_cases.end());
    all_test_cases.insert(all_test_cases.end(), int64_test_cases.begin(),
                          int64_test_cases.end());
    all_test_cases.insert(all_test_cases.end(), uint8_test_cases.begin(),
                          uint8_test_cases.end());
    all_test_cases.insert(all_test_cases.end(), uint16_test_cases.begin(),
                          uint16_test_cases.end());
    all_test_cases.insert(all_test_cases.end(), uint32_test_cases.begin(),
                          uint32_test_cases.end());
    all_test_cases.insert(all_test_cases.end(), uint64_test_cases.begin(),
                          uint64_test_cases.end());
...
class StringConversion : public ::testing::Test {
 protected:
  ...
  std::vector<StringToDoubleTestCase> float_test_cases() {
    ...
    all_test_cases.insert(all_test_cases.end(), float64_test_cases.begin(),
                          float64_test_cases.end());
    all_test_cases.insert(all_test_cases.end(), float32_test_cases.begin(),
                          float32_test_cases.end());
    return all_test_cases;
  }
