...
protected:
    ...
    std::vector<StringToDoubleTestCase> float_test_cases() {
        ...
        all_test_cases.insert(all_test_cases.end(), float64_test_cases.begin(), float64_test_cases.end());
        all_test_cases.insert(all_test_cases.end(), float32_test_cases.begin(), float32_test_cases.end());
        return all_test_cases;
    }
