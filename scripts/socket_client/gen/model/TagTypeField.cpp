...
nlohmann::json TagTypeField::to_json() const
{
    nlohmann::json j;
...
TagTypeField TagTypeField::from_json(const nlohmann::json& j)
{
    TagTypeField o{};
...
void TagTypeField::validate() const
{
...
bool TagTypeField::validate(std::stringstream& msg) const
{
    return validate(msg, "");
}

bool TagTypeField::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "TagTypeField" : pathPrefix;
...
bool TagTypeField::operator==(const TagTypeField& other) const
{
    return
    
    object == other.object && id == other.id && schema_path == other.schema_path && created_at == other.created_at && updated_at == other.updated_at && created_by_id == other.created_by_id && updated_by_id == other.updated_by_id && tag_type_id == other.tag_type_id && created_by == other.created_by && updated_by == other.updated_by && tag_type == other.tag_type;
}
...
void to_json(nlohmann::json& j, const TagTypeField& o)
{
    ...
    if (o.tag_type_id.has_value()) {
        j["tag_type_id"] = o.tag_type_id.value();
    }
...
void from_json(const nlohmann::json& j, TagTypeField& o)
{
    ...
    if (j.find("tag_type_id") != j.end()) {
        if (j.at("tag_type_id").is_null()) {
            o.tag_type_id = std::nullopt;
        } else {
            o.tag_type_id = j.at("tag_type_id").get<std::string>();
        }
    }
