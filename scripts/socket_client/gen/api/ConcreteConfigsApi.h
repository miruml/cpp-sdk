...
private:
    ...
    virtual void get_latest_concrete_config(const std::string &clientId, const std::optional<std::string> &configSchemaDigest, Pistache::Http::ResponseWriter &response) = 0;
