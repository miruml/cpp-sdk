...
#ifndef ConfigSchemasApi_H_
#define ConfigSchemasApi_H_
...
class  ConfigSchemasApi : public ApiBase {
public:
    explicit ConfigSchemasApi(const std::shared_ptr<Pistache::Rest::Router>& rtr);
    ~ConfigSchemasApi() override = default;
    void init() override;
