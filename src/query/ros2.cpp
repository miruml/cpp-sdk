...
bool ROS2::has_parameter(const std::string& parameter_name) {
...
Parameter ROS2::get_parameter(const std::string& name) const {
  SearchParamFiltersBuilder builder;
...
bool ROS2::get_parameter(const std::string& name, Parameter& parameter) const {
  SearchParamFiltersBuilder builder;
  builder.with_param_name(name);
  SearchParamFilters filters = builder.build();
...
std::vector<Parameter> ROS2::get_parameters(const std::vector<std::string>& names
) const {
