...
std::string to_string(const ParameterValue& value, const int indent) {
  switch (value.get_type()) {
    ...
    case ParameterType::PARAMETER_BOOL_ARRAY: {
      ...
      return to_string(bool_array, 0, false);
    }
    case ParameterType::PARAMETER_INTEGER_ARRAY: {
      ...
      return to_string(int_array, 0, false);
    }
    case ParameterType::PARAMETER_DOUBLE_ARRAY: {
      ...
      return to_string(double_array, 0, false);
    }
    case ParameterType::PARAMETER_STRING_ARRAY: {
      ...
      return to_string(string_array, 0, false);
    }
    ...
    case ParameterType::PARAMETER_SCALAR_ARRAY: {
      ...
      return to_string(scalar_array, 0, false);
    }
    case ParameterType::PARAMETER_NESTED_ARRAY: {
      ...
      return to_string(nested_array, 0, true);
    }
    case ParameterType::PARAMETER_MAP: {
      return to_string(value.get<Map>(), indent);
    }
    case ParameterType::PARAMETER_MAP_ARRAY: {
      ...
      return to_string(map_array, 0, true);
    }
  }
  return "unknown type";
}
